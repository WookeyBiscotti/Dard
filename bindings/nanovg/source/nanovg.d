...
NVGcontext* nvgCreateC (int _edgeaa, ushort _viewId);
...
struct NVGglyphPosition
{
    ...
    float minx;
    float maxx; // The bounds of the glyph shape.
}
...
struct NVGtextRow
{
    ...
    float minx;
    float maxx; // Actual bounds of the row. Logical with and bounds can differ because of kerning and some parts over extending.
}
...
struct NVGparams
{
    ...
    int function (void* uptr, int type, int w, int h, int imageFlags, const(ubyte)* data) renderCreateTexture;
    ...
    void function (void* uptr, float width, float height, float devicePixelRatio) renderViewport;
    void function (void* uptr) renderCancel;
    void function (void* uptr) renderFlush;
    void function (void* uptr, NVGpaint* paint, NVGcompositeOperationState compositeOperation, NVGscissor* scissor, float fringe, const(float)* bounds, const(NVGpath)* paths, int npaths) renderFill;
    void function (void* uptr, NVGpaint* paint, NVGcompositeOperationState compositeOperation, NVGscissor* scissor, float fringe, float strokeWidth, const(NVGpath)* paths, int npaths) renderStroke;
    void function (void* uptr, NVGpaint* paint, NVGcompositeOperationState compositeOperation, NVGscissor* scissor, const(NVGvertex)* verts, int nverts) renderTriangles;
