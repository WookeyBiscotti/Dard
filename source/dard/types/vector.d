...
//  */
// auto vector(A = typeof(theAllocator), E)(E[] elements...)
// if (isAllocator!A && isGlobal!A) {
//     return Vector!(E, A)(elements);
// }

// /// ditto
// auto vector(A = typeof(theAllocator), E)(A allocator, E[] elements...)
// if (isAllocator!A && !isGlobal!A) {
...
//    and the allocator.
//  */
// auto vector(A = typeof(theAllocator), R)(R range)
...
// /// ditto
// auto vector(A = typeof(theAllocator), R)(A allocator, R range)
// if (isAllocator!A && !isGlobal!A && isInputRange!R) {
//     import automem.vector : ElementType;
...
//         return Vector(chain(() @trusted { return this[]; }(), () @trusted {
//                 return other[];
//             }()));
//     }
...
//     void opOpAssign(string op)(E other) scope if (op == "~") {
//         put(other);
//     }

//     void put(ref E other) {
...
//                 moveEmplace(_elements[lastIndex], other);
//             }
//         } else {
...
//         return Range(() @trusted { return &this; }(), start, end);
//     }
...
//     bool opEquals(R)(R range) scope const if (isInputRangeOf!(R, E)) {
//         import std.array : empty, popFront, front;

//         if (length == 0 && range.empty)
//             return true;

//         foreach (i; 0 .. length) {
//             if (range.empty)
//                 return false;
//             if (range.front != this[i])
//                 return false;
//             range.popFront;
//         }
...
// // package void defaultDestroy(T)(ref T v) if (is(T == struct)) {
// //     v.__dtor();
// // }
...
// // package void defaultInit(T)(ref T v) if (is(T == struct)) {
// //     v.__dtor();
// // }
...
// // struct Array2(T, Allocator = Mallocator) if (!is(T == class) && !is(T == interface)) {
// // public:
// //      ~this() {
// //         if (_capacity != 0) {
// //             Allocator.instance.deallocate(cast(void[]) _storage[0 .. _capacity]);
// //         }
// //     }
...
// //                 defaultInit(_storage[i]);
// //             }
// //         } else {
// //             for (size_t i = newSize; i < _size; i++) {
// //                 defaultDestroy(_storage[i]);
// //             }
// //         }
...
// //                 newCapacity = 4;
// //             } else {
// //                 newCapacity = cast(size_t)((_capacity + 1) * 1.87);
// //             }
...
// //     ref auto opOpAssign(string op)(T c) if (op == "~") {
// //         pushBack(c);
